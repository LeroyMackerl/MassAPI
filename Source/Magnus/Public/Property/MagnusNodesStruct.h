...
// 属性过滤器注册表
class MAGNUS_API FStructMemberPropertyFilterRegistry
{
public:
	// 注册一个命名过滤器
...
struct MAGNUS_API FStructMemberTreeNode
{
	GENERATED_BODY()
...
// 结构体成员引用
USTRUCT(BlueprintType)
struct MAGNUS_API FStructMemberReference
{
	GENERATED_BODY()
...
// 递归结构体成员引用
USTRUCT(BlueprintType)
struct MAGNUS_API FStructRecursiveMemberReference
{
	GENERATED_BODY()
