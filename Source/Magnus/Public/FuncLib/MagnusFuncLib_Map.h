...
UCLASS()
class MAGNUS_API UMagnusNodesFuncLib_MapHelper : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
UCLASS()
class MAGNUS_API UMagnusFuncLib_MapTree : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
