...
#include "K2Node_GetFragmentFromTemplate.generated.h"

UCLASS()
class MASSAPIUNCOOKED_API UK2Node_GetFragmentFromTemplate : public UK2Node_FragmentFunction
{
	GENERATED_BODY()

public:
	UK2Node_GetFragmentFromTemplate();
