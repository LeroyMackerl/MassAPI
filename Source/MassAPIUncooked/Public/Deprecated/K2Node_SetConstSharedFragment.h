...
#include "K2Node_SetConstSharedFragment.generated.h"

UCLASS()
class MASSAPIUNCOOKED_API UK2Node_SetConstSharedFragment : public UK2Node_FragmentFunction
{
	GENERATED_BODY()

public:
	UK2Node_SetConstSharedFragment();
