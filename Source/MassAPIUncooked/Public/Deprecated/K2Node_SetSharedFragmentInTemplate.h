...
#include "K2Node_SetSharedFragmentInTemplate.generated.h"

UCLASS()
class MASSAPIUNCOOKED_API UK2Node_SetSharedFragmentInTemplate : public UK2Node_FragmentFunction
{
	GENERATED_BODY()

public:
	UK2Node_SetSharedFragmentInTemplate();
