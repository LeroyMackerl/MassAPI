...
#include "K2Node_SetConstSharedFragmentInTemplate.generated.h"

UCLASS()
class MASSAPIUNCOOKED_API UK2Node_SetConstSharedFragmentInTemplate : public UK2Node_FragmentFunction
{
	GENERATED_BODY()

public:
	UK2Node_SetConstSharedFragmentInTemplate();
