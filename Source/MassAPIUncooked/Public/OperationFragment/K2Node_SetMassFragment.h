...
public:
	...
	/** Cached pin state for preservation during reconstruction */
	struct FCachedPinState
	{
		FString DefaultValue;
		FString AutogeneratedDefaultValue;
		TArray<UEdGraphPin*> LinkedTo;  // Connections to restore
	};

	/** Temporary storage for old pin state during reconstruction (used by OnMemberReferenceChanged) */
	TMap<FName, FCachedPinState> CachedOldPinStates;
