...
#include "K2Node_GetConstSharedFragment.generated.h"

UCLASS()
class MASSAPIUNCOOKED_API UK2Node_GetConstSharedFragment : public UK2Node_FragmentFunction
{
	GENERATED_BODY()

public:
	UK2Node_GetConstSharedFragment();
