...
#include "K2Node_GetSharedFragment.generated.h"

UCLASS()
class MASSAPIUNCOOKED_API UK2Node_GetSharedFragment : public UK2Node_FragmentFunction
{
	GENERATED_BODY()

public:
	UK2Node_GetSharedFragment();
