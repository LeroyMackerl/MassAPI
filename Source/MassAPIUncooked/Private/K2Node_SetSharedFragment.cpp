#include "K2Node_SetSharedFragment.h"
...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIBPFnLib, SetSharedFragment), UMassAPIBPFnLib::StaticClass());
}

FText UK2Node_SetSharedFragment::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("Set Shared Mass Fragment"));
}
