...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIBPFnLib, SetConstSharedFragment), UMassAPIBPFnLib::StaticClass());
}

FText UK2Node_SetConstSharedFragment::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("Set Const Shared Mass Fragment"));
}
