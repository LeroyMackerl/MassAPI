...
#include "K2Node_GetSharedFragment.h"
...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIBPFnLib, GetSharedFragment), UMassAPIBPFnLib::StaticClass());
}

FText UK2Node_GetSharedFragment::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("Get Shared Mass Fragment"));
}
