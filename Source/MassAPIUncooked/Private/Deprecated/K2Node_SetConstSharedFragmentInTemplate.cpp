...
#include "Deprecated/K2Node_SetConstSharedFragmentInTemplate.h"
...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIFuncLib, SetConstSharedFragmentInTemplate), UMassAPIFuncLib::StaticClass());
}

FText UK2Node_SetConstSharedFragmentInTemplate::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("SetConstSharedFragmentInTemplate(Deprecated)"));
}

FText UK2Node_SetConstSharedFragmentInTemplate::GetMenuCategory() const
{
