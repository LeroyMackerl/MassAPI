...
#include "Deprecated/K2Node_GetFragmentFromTemplate.h"
...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIFuncLib, GetFragmentFromTemplate), UMassAPIFuncLib::StaticClass());
}

FText UK2Node_GetFragmentFromTemplate::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("GetFragmentfromTemplate(Deprecated)"));
}

FText UK2Node_GetFragmentFromTemplate::GetMenuCategory() const
{
