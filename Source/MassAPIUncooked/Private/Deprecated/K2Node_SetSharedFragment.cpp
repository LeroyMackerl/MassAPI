...
#include "Deprecated/K2Node_SetSharedFragment.h"
...
const FName UK2Node_SetSharedFragment::FragmentInPinName(TEXT("InFragment"));

UK2Node_SetSharedFragment::UK2Node_SetSharedFragment()
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIFuncLib, SetSharedFragment), UMassAPIFuncLib::StaticClass());
}

FText UK2Node_SetSharedFragment::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("SetSharedFragment(Deprecated)"));
}

FText UK2Node_SetSharedFragment::GetMenuCategory() const
{
    return FText::FromString(TEXT("MassAPI|ZDeprecated"));
}

void UK2Node_SetSharedFragment::ReallocatePinsDuringReconstruction(TArray<UEdGraphPin*>& OldPins)
{
...
void UK2Node_SetSharedFragment::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UK2Node_SetSharedFragment::OnFragmentTypeChanged()
{
...
bool UK2Node_SetSharedFragment::IsValidFragmentStruct(const UScriptStruct* Struct) const
{
