...
#include "Deprecated/K2Node_SetFragmentInTemplate.h"
...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIFuncLib, SetFragmentInTemplate), UMassAPIFuncLib::StaticClass());
}

FText UK2Node_SetFragmentInTemplate::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("SetFragmentInTemplate(Deprecated)"));
}

FText UK2Node_SetFragmentInTemplate::GetMenuCategory() const
{
