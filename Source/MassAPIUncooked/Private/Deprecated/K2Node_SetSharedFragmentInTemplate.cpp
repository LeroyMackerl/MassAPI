...
#include "Deprecated/K2Node_SetSharedFragmentInTemplate.h"
...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIFuncLib, SetSharedFragmentInTemplate), UMassAPIFuncLib::StaticClass());
}

FText UK2Node_SetSharedFragmentInTemplate::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("SetSharedFragmentInTemplate(Deprecated)"));
}

FText UK2Node_SetSharedFragmentInTemplate::GetMenuCategory() const
{
