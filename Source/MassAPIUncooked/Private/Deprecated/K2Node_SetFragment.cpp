...
#include "Deprecated/K2Node_SetFragment.h"
...
{
    FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UMassAPIFuncLib, SetFragment), UMassAPIFuncLib::StaticClass());
}

FText UK2Node_SetFragment::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return FText::FromString(TEXT("SetMassFragment(Deprecated)"));
}

FText UK2Node_SetFragment::GetMenuCategory() const
{
