...
#include "MagnusNode_MapTreeContains.generated.h"
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

UCLASS()
class MAGNUSUNCOOKED_API UMagnusNode_MapTreeContains : public UK2Node
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "MapTreeContains", meta=(PropertyFilter="ContainerOnly"))
